...
function Calcula(){
	...
	for (i=0;i<Alumne.nombreMatricules;i++){
		Alumne.afegeixTramit(tramits.matrTelematicaLliures, i);
	}

	//Fotocòpia DNI
	Alumne.afegeixDocument(altresDocuments.fotocopiaDNI);

	// Full de proteccio de dades, obligarori per tothom
...
function avisData(){
	...
	var inici = new Date(2019, 9, 12, 9,0,0),
		final = new Date(2019, 9, 30, 22, 0, 0),
		avui = new Date(),
		avis;
